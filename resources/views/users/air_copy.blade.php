...
<body>
    <div class="header">
        <span style="float: left; margin-left: 25px;">Airport Pickup</span>
    </div>
            ...
            <div class="slider slider-for" id='content'>
                <div id='home'>
                    <form id="pickform" method="POST" action="{{ route('book.flight') }}">
                        ...
                        <div class="text-input">
                            <input id="date" type="date" name="date" placeholder="Date of Flight" autocomplete="off"
                                required />
                        ...
                        <div id="holder">
                            ...
                            <div class="button" onclick="submitfunc();">
                            ...
                            <div class="button" onclick="window.location.href='{{ route('home') }}'">
                ...
                <div id='save'>
                    <form id="pickform" method="POST" action="{{ route('book.flight') }}">
                        {{ csrf_field() }}
                        <input type="hidden" name="val_type" value="2">
                        <div class="text-input">
                            <input id="flight_num" type="text" name="flightno" placeholder="Enter Flight Number"
                                autocomplete="off" required />
                            <label for="flight_num">Flight Number</label>
                        </div>
                        ...
                        <div class="text-input">
                            <input id="nopeople" name="nopeople" type="number" placeholder="Total People Number"
                                autocomplete="off" required />
                            <label for="nopeople">Number of People</label>
                        </div>
                        ...
                        <div id="holder">
                            ...
                            <div class="button" onclick="submitfunctwo();">
                                <p class="btnText">READY?</p>
                                <div class="btnTwo">
                                    <p class="btnText2">GO!</p>
                                </div>
